...
const Noteitem = (props) => {
  ...
  const deleten=()=>{
    deleteNote(noteId);  
    props.salert({type:'success', msg:'note deleted successfully'});
  }
  // console.log(data)
    return (
      <div
      ...
      <div className="card-body">
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          ...
          <div>
            <img height={"15px"} className="mx-1" src="delete.png" title="delete note" alt="delete" style={{cursor: "pointer"}} onClick={deleten}/>
            <UpdateModal note={data} salert={props.salert}/>
          </div>
        </div>
